...
UPlayFabProfilesAPI* UPlayFabProfilesAPI::SetDisplayName(FProfilesSetDisplayNameRequest Request, UPlayFabProfilesAPI::FDelegateOnSuccessSetDisplayName onSuccess, UPlayFabProfilesAPI::FDelegateOnFailurePlayFabError onFailure, UObject* customData) {
    return NULL;
}

UPlayFabProfilesAPI* UPlayFabProfilesAPI::SetAvatarUrl(FProfilesSetAvatarUrlRequest Request, UPlayFabProfilesAPI::FDelegateOnSuccessSetAvatarUrl onSuccess, UPlayFabProfilesAPI::FDelegateOnFailurePlayFabError onFailure, UObject* customData) {
    return NULL;
}
...
void UPlayFabProfilesAPI::HelperSetAvatarUrl(FPlayFabBaseModel response, UObject* customData, bool successful) {
}
