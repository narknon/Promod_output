...
public:
    ...
    static void setPlayFabSettings(const FString& GameTitleId, const FString& PlayFabSecretApiKey, const FString& PhotonRealtimeAppId, const FString& PhotonTurnbasedAppId, const FString& PhotonChatAppId);
