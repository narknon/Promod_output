...
include $(CLEAR_VARS)
LOCAL_MODULE    := Ak3DAudioBedMixerFX
LOCAL_SRC_FILES := ../../../../Android_$(APP_ABI)/$(CONFIGURATION)/lib/libAk3DAudioBedMixerFX.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := Ak3DAudioBedMixer
LOCAL_MODULE_FILENAME := libAk3DAudioBedMixer

LOCAL_SRC_FILES := ../InitPlugins.cpp

ifeq ($(PM5_CONFIG),debug_android_armeabi-v7a)
  LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../../../include
  LOCAL_STATIC_LIBRARIES := Ak3DAudioBedMixerFX
