...
LOCAL_SRC_FILES := ../../../../Android_$(APP_ABI)/$(CONFIGURATION)/lib/libAkGuitarDistortionFX.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := AkGuitarDistortion
LOCAL_MODULE_FILENAME := libAkGuitarDistortion
