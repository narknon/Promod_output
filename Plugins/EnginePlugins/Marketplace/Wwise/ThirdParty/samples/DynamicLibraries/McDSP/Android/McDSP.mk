...
LOCAL_SRC_FILES := ../../../../Android_$(APP_ABI)/$(CONFIGURATION)/lib/libMcDSPFutzBoxFX.a
include $(PREBUILT_STATIC_LIBRARY)
include $(CLEAR_VARS)
LOCAL_MODULE    := McDSPLimiterFX
LOCAL_SRC_FILES := ../../../../Android_$(APP_ABI)/$(CONFIGURATION)/lib/libMcDSPLimiterFX.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := McDSP
LOCAL_MODULE_FILENAME := libMcDSP

LOCAL_SRC_FILES := ../InitPlugins.cpp

ifeq ($(PM5_CONFIG),debug_android_armeabi-v7a)
  LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../../../include
  LOCAL_STATIC_LIBRARIES := McDSPFutzBoxFX McDSPLimiterFX
