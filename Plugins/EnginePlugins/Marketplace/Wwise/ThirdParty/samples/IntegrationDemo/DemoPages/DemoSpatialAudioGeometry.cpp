...
int DemoSpatialAudioGeometry::AKPosToPixels_X(double in_X)
{
	return (int)(((in_X / POSITION_RANGE) + 0.5f) * m_fWidth);
}

int DemoSpatialAudioGeometry::AKPosToPixels_Y(double in_y)
{
...
void DemoSpatialAudioGeometry::Init_Geometry()
{
	...
	*/
	...
	instanceParams.GeometrySetID = 0;
	AK::SpatialAudio::SetGeometryInstance(0, instanceParams);
