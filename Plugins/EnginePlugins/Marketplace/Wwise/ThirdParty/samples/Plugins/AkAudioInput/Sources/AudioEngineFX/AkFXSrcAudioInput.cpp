...
AK_ATTR_USED AK::PluginRegistration AkAudioInputSourceRegistration(AkPluginTypeSource, AKCOMPANYID_AUDIOKINETIC, 200, CreateAudioInputSource, CreateAudioInputSourceParams);
