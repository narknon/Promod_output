...
LOCAL_MODULE_FILENAME := libAkSineSource

LOCAL_SRC_FILES := ../../../../../DSP/AkSineOsc.cpp ../AkFXSrcSine.cpp ../AkFXSrcSineParams.cpp

ifeq ($(PM5_CONFIG),debug_android_armeabi-v7a)
  LOCAL_C_INCLUDES := $(LOCAL_PATH)/.. $(LOCAL_PATH)/. $(LOCAL_PATH)/../../../../../../include $(LOCAL_PATH)/../../Common/Android $(LOCAL_PATH)/../../Common $(LOCAL_PATH)/../../../Common $(LOCAL_PATH)/../../../../../DSP
