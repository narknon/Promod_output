...
ifeq ($(PM5_CONFIG),debug_android_armeabi-v7a)
  LOCAL_C_INCLUDES := $(LOCAL_PATH)/. $(LOCAL_PATH)/../examples $(LOCAL_PATH)/../lib $(LOCAL_PATH)/../m4 $(LOCAL_PATH)/../man $(LOCAL_PATH)/../regress $(LOCAL_PATH)/../src $(LOCAL_PATH)/../xcode $(LOCAL_PATH)/../examples/.deps $(LOCAL_PATH)/../lib/.deps $(LOCAL_PATH)/../regress/.deps $(LOCAL_PATH)/../src/.deps $(LOCAL_PATH)/../xcode/libzip.xcodeproj $(LOCAL_PATH)/../xcode/libzip.xcodeproj/project.xcworkspace
  LOCAL_CFLAGS := -Werror -D_DEBUG -mfloat-abi=softfp -mfpu=neon -ffast-math -fvisibility=hidden -fno-omit-frame-pointer -g
...
ifeq ($(PM5_CONFIG),debug_android_x86)
  LOCAL_C_INCLUDES := $(LOCAL_PATH)/. $(LOCAL_PATH)/../examples $(LOCAL_PATH)/../lib $(LOCAL_PATH)/../m4 $(LOCAL_PATH)/../man $(LOCAL_PATH)/../regress $(LOCAL_PATH)/../src $(LOCAL_PATH)/../xcode $(LOCAL_PATH)/../examples/.deps $(LOCAL_PATH)/../lib/.deps $(LOCAL_PATH)/../regress/.deps $(LOCAL_PATH)/../src/.deps $(LOCAL_PATH)/../xcode/libzip.xcodeproj $(LOCAL_PATH)/../xcode/libzip.xcodeproj/project.xcworkspace
  LOCAL_CFLAGS := -Werror -D_DEBUG -ffast-math -fvisibility=hidden -fno-omit-frame-pointer -g
  LOCAL_CPPFLAGS := -Wno-conversion-null -Wno-deprecated-declarations -fvisibility=hidden -fno-rtti -fno-exceptions -std=c++14
  LOCAL_CONLYFLAGS := -std=c11
  cmd-strip :=
  include $(BUILD_STATIC_LIBRARY)
