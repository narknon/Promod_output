...
namespace StreamMgr
{
	inline void MonitorFileOpenError(AKRESULT in_eRes, AkFileID in_fileID, const AkOSChar* in_pszFilePath = AKTEXT(" "));
	inline void MonitorFileOpenError(AKRESULT in_eRes, const AkOSChar * in_pszFileName, const AkOSChar* in_pszFilePath = AKTEXT(" "));
