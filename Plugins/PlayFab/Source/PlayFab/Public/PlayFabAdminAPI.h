...
public:
    ...
    DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateOnSuccessGetCloudScriptAzureFunctionsTaskInstance, FAdminGetCloudScriptAzureFunctionsTaskInstanceResult, Result, UObject*, customData);
    ...
    DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateOnSuccessCreateCloudScriptAzureFunctionsTask, FAdminCreateTaskResult, Result, UObject*, customData);
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void HelperGetCloudScriptAzureFunctionsTaskInstance(FPlayFabBaseModel response, UObject* customData, bool successful);
    ...
    UFUNCTION(BlueprintCallable)
    void HelperCreateCloudScriptAzureFunctionsTask(FPlayFabBaseModel response, UObject* customData, bool successful);
    ...
    UFUNCTION(BlueprintCallable)
    static UPlayFabAdminAPI* GetCloudScriptAzureFunctionsTaskInstance(FAdminGetTaskInstanceRequest Request, UPlayFabAdminAPI::FDelegateOnSuccessGetCloudScriptAzureFunctionsTaskInstance onSuccess, UPlayFabAdminAPI::FDelegateOnFailurePlayFabError onFailure, UObject* customData);
    ...
    UFUNCTION(BlueprintCallable)
    static UPlayFabAdminAPI* CreateCloudScriptAzureFunctionsTask(FAdminCreateCloudScriptAzureFunctionsTaskRequest Request, UPlayFabAdminAPI::FDelegateOnSuccessCreateCloudScriptAzureFunctionsTask onSuccess, UPlayFabAdminAPI::FDelegateOnFailurePlayFabError onFailure, UObject* customData);
