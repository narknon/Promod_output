...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static UPlayFabClientAPI* UnlinkOpenIdConnect(FClientUninkOpenIdConnectRequest Request, UPlayFabClientAPI::FDelegateOnSuccessUnlinkOpenIdConnect onSuccess, UPlayFabClientAPI::FDelegateOnFailurePlayFabError onFailure, UObject* customData);
